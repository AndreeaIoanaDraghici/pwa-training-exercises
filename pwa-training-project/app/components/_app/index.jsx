    ...
    useEffect(() => {
        ...
        const fetchStore = async () => {
            const res = await fetch(
                `${getAppOrigin()}/mobify/proxy/ocapi/s/RefArch/dw/shop/v20_2/stores?latitude=${GEO_LOCATION.lat}&longitude=${GEO_LOCATION.long}&client_id=1d763261-6522-4913-9d52-5d947d3b94c4`
            )
            if (res.ok) {
...
`
    ...
    const result = await fetch(
        `${getAppOrigin()}/mobify/proxy/ocapi/s/RefArch/dw/shop/v20_2/content/privacy-policy?client_id=1d763261-6522-4913-9d52-5d947d3b94c4`
    )
